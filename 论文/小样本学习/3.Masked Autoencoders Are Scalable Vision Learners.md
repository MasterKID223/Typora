...
- `非对称架构`
  ...
  > <img src="pic\image-20220915215055140.png" alt="image-20220915215055140" style="zoom:33%;" />
...
- `Masking`
  ...
  > Imagenet
  >
  > <img src="pic\image-20220915222938132.png" alt="image-20220915222938132" style="zoom:33%;" />
  >
  > COCO
  >
  > <img src="pic\image-20220915223057255.png" alt="image-20220915223057255" style="zoom:33%;" />
  >
...
- `Decoder design`
  ...
  > <img src="pic/image-20220917090941596.png" alt="image-20220917090941596" style="zoom:25%;" />
...
- `Mask token`
  ...
  > <img src="pic/image-20220917094028433.png" alt="image-20220917094028433" style="zoom:25%;" />
  ...
  > <img src="pic/image-20220917102115133.png" alt="image-20220917102115133" style="zoom:25%;" />

### A.2. 监督训练ViT-L/H（从头开始）

在ImageNet-1K上从头训练，不简单，不稳定。现有的一些强baseline的实现是针对小模型的，对于更大俄ViT-L/H不可行，用在小模型上的baseline直接用到ViT-l/H时，训练时经常出现NaN的损失。

表11是作者实现的配置，`wd=0.3,bs=4096,a long warmup`遵循原来ViT[16]的设置。$\beta_2=0.95$遵循[6]。只使用表11中用到的正则化，不用其他的，遵循[64]。其他参数都是提高训练稳定程度的。按照这个配置，训练过程中不会出现NaN损失。

<img src="./pic/image-20230117164245417.png" alt="image-20230117164245417" style="zoom:33%;" />
...
ViT-L和ViT-H都展示过拟合的趋势，如果不使用EMA的话。
