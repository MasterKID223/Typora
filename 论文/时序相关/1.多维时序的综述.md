...
- [VELC（2019）](https://arxiv.org/pdf/1907.01702)
- [PAD（2021）](https://arxiv.org/pdf/1910.03818)

<hr>

- [TopoMAD（2020）](https://yuxiaoba.github.io/publication/topomad20/topomad20.pdf) 
- [VAE-GAN（2020）](https://www.mdpi.com/760324)

<hr>

- [RDSSM（2022）](https://ieeexplore.ieee.org/abstract/document/9773982/)

#### 3.2.3. GAN

- [BeatGAN（2019）](https://www.ijcai.org/Proceedings/2019/0616.pdf)：Anomalous Rhythm Detection using Adversarially Generated
  Time Series
- [MAD-GAN（2019）](https://arxiv.org/pdf/1901.04997)：MAD-GAN: Multivariate anomaly detection for time series data with generative adversarial network
...
- [Anomaly Transformer（2021）](https://arxiv.org/pdf/2110.02642)：Time series anomaly detection with association discrepancy
- [TranAD（2022）](https://arxiv.org/pdf/2201.07284)：Deep transformer networks for anomaly detection in multivariate time
  series data.
- [MT-RVAE（2022）](https://www.sciencedirect.com/science/article/pii/S0263224122000914)：Variational transformer-based anomaly detection approach for multivariate time series
...
- [NSIBF（2021）](https://arxiv.org/pdf/2106.07992)：Time series anomaly detection for cyber-physical systems via neural system identification and bayesian filtering.

#### 3.3.2. RNN

- [TAnoGan（2020）](https://arxiv.org/pdf/2008.09567) ：TAnoGAN: Time series anomaly detection with generative adversarial networ
...
- [TSiT（2023）](https://arxiv.org/pdf/2211.14730)：A Time Series is Worth 64 Words: Long-term Forecasting with Transformers
  ...
  <img src="pic/image-20230214041835789.png" alt="image-20230214041835789" style="zoom:25%;" />
