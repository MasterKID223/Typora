...
- 全局的（Global）：在时序曲线种是波峰，一般是极小或极大值点。
  $$
...
**[AOC](https://blog.csdn.net/liweibin1994/article/details/79462554)** 值在0.5-1之间，判断分类器的好坏，越接近1分类器效果越好。
...
<img src="pic/QQ截图20230213021117.png" style="zoom: 25%;" />
...
- [DeepLSTM（2015）](https://www.researchgate.net/profile/Sucheta-Chauhan/publication/308852664_Anomaly_detection_in_ECG_time_signals_via_deep_long_short-term_memory_networks/links/5a719365458515015e64a698/Anomaly-detection-in-ECG-time-signals-via-deep-long-short-term-memory-networks.pdf) ：Anomaly detection in ECG time signals via deep long short-term memory networks

  能够产生更好的特征。

  <img src="pic/image-20230214044633468.png" alt="image-20230214044633468" style="zoom: 50%;" />

- [ LSTM-PRED（2017）](https://www.researchgate.net/profile/Sridhar-Adepu/publication/316530203_Anomaly_Detection_in_Cyber_Physical_Systems_Using_Recurrent_Neural_Networks/links/5c93085392851cf0ae8bdfed/Anomaly-Detection-in-Cyber-Physical-Systems-Using-Recurrent-Neural-Networks.pdf)：Anomaly detection in cyber physical systems using recurrent neural networ

- NASA：[LSTM-NDT（2018）](https://arxiv.org/pdf/1802.04431)：Detecting Spacecraft Anomalies Using LSTMs and
...
- [LGMAD（2019）](https://www.sciencedirect.com/science/article/pii/S0045790618334372)：Real-time anomaly detection based on long short-Term memory and Gaussian Mixture Model
...
- [AD-LTI（2020）](https://arxiv.org/pdf/1908.01146)：Developing an Unsupervised Real-time Anomaly
  ...
  <img src="pic/image-20230214045339355.png" alt="image-20230214045339355" style="zoom:25%;" />

- [THOC（2020）](https://proceedings.neurips.cc/paper/2020/file/97e401a02082021fd24957f852e0e475-Paper.pdf) ：Time series Anomaly Detection using
...
- TCN使用空洞卷积控制模型不使用未来的数据。：An Empirical Evaluation of Generic Convolutional and Recurrent Networks
...
- [TCN-ms（2019）](https://iopscience.iop.org/article/10.1088/1742-6596/1213/4/042050/pdf)：Temporal convolutional networks for anomaly detection in time series
...
- [SAnD（2018）](https://ojs.aaai.org/index.php/AAAI/article/view/11635/11494)：临床时序数据，Attend and diagnose: Clinical time series analysis using attention
  models

  Transformer在医学数据上的应用。

  <img src="pic/image-20230214052942858.png" alt="image-20230214052942858" style="zoom:25%;" />
...
- [DAGMM（2018）](https://openreview.net/pdf?id=BJJLHbb0-) ：Deep Autoencoding Gaussian Mixture Model
...
- [USAD（2020）](https://dl.acm.org/doi/pdf/10.1145/3394486.3403392)：UnSupervised Anomaly Detection on Multivariate Time Series
...
- [APAE（2020）](https://www.ijcai.org/proceedings/2020/0173.pdf)：Robustness of Autoencoders for Anomaly Detection Under Adversarial Impact
...
- [MSCRED（2019）](https://ojs.aaai.org/index.php/AAAI/article/download/3942/3820)

  AE、ConvLSTM、attention的结合。

  <img src="pic/image-20230214005110011.png" alt="image-20230214005110011" style="zoom: 25%;" />

-  [CAE-Ensemble（2021）](https://arxiv.org/pdf/2111.11108)：Unsupervised Time Series Outlier Detection with
  Diversity-Driven Convolutional Ensembles—Extended Version
...
- [RANSysCoders（2021）](https://dl.acm.org/doi/pdf/10.1145/3447548.3467174) ：Practical Approach to Asynchronous Multivariate Time Series Anomaly Detection and Localization
...
- [AMSL（2022）](https://arxiv.org/pdf/2201.00464) ： Adaptive memory networks with self-supervised learning for unsupervised
  anomaly detection

  自我监督学习模块 ，全局记忆模块，局部记忆模块，自适应融合模块
...
- [LSTM-VAE（2018）](https://arxiv.org/pdf/1711.00614) ：A Multimodal Anomaly Detector for Robot-Assisted Feeding
...
- [OmniAnomaly](https://netman.aiops.org/wp-content/uploads/2019/08/OmniAnomaly_camera-ready.pdf)（2019） ：Robust Anomaly Detection for Multivariate Time Series
...
- [InterFusion（2021）](https://netman.aiops.org/wp-content/uploads/2021/08/KDD21_InterFusion_Li.pdf) ：Multivariate Time Series Anomaly Detection and Interpretation
...
- [SISVAE（2020）](https://arxiv.org/pdf/2102.01331) ：Anomaly detection of time series with smoothness-inducing sequential variational
  auto-encoder
...
- [VELC（2019）](https://arxiv.org/pdf/1907.01702)：VELC: A New Variational AutoEncoder Based
...
- [PAD（2021）](https://arxiv.org/pdf/1910.03818)：A Joint Model for IT Operation Series Prediction and Anomaly Detection
...
- [TopoMAD（2020）](https://yuxiaoba.github.io/publication/topomad20/topomad20.pdf)：A Spatiotemporal Deep Learning Approach for
  Unsupervised Anomaly Detection in Cloud Systems
  ...
  <img src="pic/image-20230214105544010.png" alt="image-20230214105544010" style="zoom:25%;" />

  <img src="pic/image-20230214105631826.png" alt="image-20230214105631826" style="zoom:25%;" />

  

- [VAE-GAN（2020）](https://www.mdpi.com/1424-8220/20/13/3738/pdf?version=1594212262)：LSTM-Based VAE-GAN for Time-Series
  Anomaly Detection
...
- [RDSSM（2022）](https://ieeexplore.ieee.org/abstract/document/9773982)：Learning Robust Deep State Space for Unsupervised Anomaly
...
- [BeatGAN（2019）](https://www.ijcai.org/Proceedings/2019/0616.pdf)：Anomalous Rhythm Detection using Adversarially Generated
  Time Series
...
- [MAD-GAN（2019）](https://arxiv.org/pdf/1901.04997)： Multivariate anomaly detection for time series data with generative adversarial network

  LSTM+GAN

  <img src="pic/image-20230214114011738.png" alt="image-20230214114011738" style="zoom:33%;" />

- [DAEMON（2021）](https://ieeexplore.ieee.org/abstract/document/9458835/)：Daemon: Unsupervised anomaly
  detection and interpretation for multivariate time series.
...
- [FGANomaly（2021）](https://ieeexplore.ieee.org/abstract/document/9618824/)：GAN-Based Anomaly Detection for Multivariate Time
...
- [DCT-GAN（2021）](https://ieeexplore.ieee.org/abstract/document/9626552/)： Dilated Convolutional Transformer-based GAN for Time Series
  Anomaly Detection. 

  暂时看不了。
  
- [Anomaly Transformer（2022）](https://arxiv.org/pdf/2110.02642)：Time series anomaly detection with association discrepancy
...
- [TranAD（2022）](https://arxiv.org/pdf/2201.07284)：Deep transformer networks for anomaly detection in multivariate time
  series data
...
- [MT-RVAE（2022）](https://www.sciencedirect.com/science/article/pii/S0263224122000914/pdfft?md5=7bddbf136fc425e55ac6fed3a9a1d6e2&pid=1-s2.0-S0263224122000914-main.pdf)：Variational transformer-based anomaly detection approach for multivariate time series
...
- [CAE-M（2021）](https://arxiv.org/pdf/2107.12626)： Unsupervised deep anomaly detection for multi-sensor time-series signals.
...
- [LogTrans（2019）](https://proceedings.neurips.cc/paper/2019/file/6775a0635c302542da2c32aa19d86be0-Paper.pdf)：Enhancing the locality and breaking the memory bottleneck of transformer on time series forecasting
...
- [Informer（2021）](https://ojs.aaai.org/index.php/AAAI/article/download/17325/17132)：Beyond efficient transformer for long sequence time-series forecasting
...
- [AutoFormer（2021）](https://proceedings.neurips.cc/paper/2021/file/bcc0d400288793e8bdcd7c19a8ac0c2b-Paper.pdf)：Decomposition transformers with auto-correlation for long-term series forecasting
...
- [FedFormer（2022）](https://proceedings.mlr.press/v162/zhou22g/zhou22g.pdf)：Frequency enhanced decomposed transformer for long-term series forecasting
...
- [PyraFormer（2022）](https://openreview.net/pdf?id=0EXmFzUn5I)：Low-complexity pyramidal attention for long-range time series modeling and forecasting
...
- [Are Transformers Effective for Time Series Forecasting?（2022）](https://arxiv.org/pdf/2205.13504.pdf%E2%80%9D)
  ...
  <img src="pic/image-20230214041232944.png" alt="image-20230214041232944" style="zoom:25%;" />

- [TSiT（2023）](https://arxiv.org/pdf/2211.14730)：A Time Series is Worth 64 Words: Long-term Forecasting with Transformers

  作者说，Transformer效果没有DLinear好是因为没找到时序在transformer上的正确用法。

  <img src="pic/image-20230214041835789.png" alt="image-20230214041835789"  />

- [LaST（2022）](https://openreview.net/pdf?id=C9yUwd72yy)：Learning Latent Seasonal-Trend Representations for Time Series Forecasting
...
时序分类的一篇综述（2023）：[Deep Learning for Time Series Classification and Extrinsic Regression: A Current Survey](https://arxiv.org/pdf/2302.02515)

<img src="pic/image-20230212230401926.png" alt="image-20230212230401926" style="zoom: 25%;" />

## 6. 基于图的时序异常检测

基于图的异常检测综述（2023）：[Graph-based Time-Series Anomaly Detection: A Survey](https://arxiv.org/pdf/2302.00058)

<img src="pic/image-20230214023718221.png" alt="image-20230214023718221" style="zoom:25%;" />
...
GNN中，图节点通过彼此交换信息来迭代更新其表示。在MTS异常检测中，每个维度（指标）就是图中的一个节点。图中的边就表示从MTS中学到的相关性。
