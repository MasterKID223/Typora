...
1. 参数
   ...
   > ![image-20220713160124684](F:\Typora\pytorch\5.torch.nn里的网络层.assets\image-20220713160124684.png)
   >
   > - N是batch_size
   > - C是通道数
   > - ★是卷积运算
   ...
   > 计算 output 形状
   >
   > ![image-20220713161457520](F:\Typora\pytorch\5.torch.nn里的网络层.assets\image-20220713161457520.png)
